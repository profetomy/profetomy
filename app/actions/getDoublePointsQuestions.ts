...
export async function getDoublePointsQuestions(): Promise<{ data: Question[] | null, error: string | null }> {
  try {
    const supabase = await createClient();

    // Fetch questions where double_points is true
    ...
    console.error('Error getting double points questions:', err);
