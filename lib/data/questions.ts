...
export const allQuestions: Question[] = [
  ...
  {
    q: "DOBLE PUNTAJE. ¿Cuál de las siguientes afirmaciones es FALSA?",
  ...
  {
    q: "DOBLE PUNTAJE. En la calle que muestra la imagen no hay señales que establezcan la velocidad máxima permitida. ¿Cuál sería entonces dicha velocidad para quien conduce?",
    a: "60 km/h",
    b: "50 km/h",
    c: "40 km/h",
    correct: "b",
